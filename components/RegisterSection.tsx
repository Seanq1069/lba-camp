        ...
        {c.registrationOpen ? (
          <>
            <p className="mx-auto mt-3 max-w-xl text-white/80">
              Spots are limited to {c.maxEnrollment}. Registration takes about two minutes. Signed waiver and payment
              are due at check-in on the first day of camp.
            </p>
            <Link
              href="/register"
          ...
          <p className="mx-auto mt-3 max-w-xl text-white/80">{c.registrationClosedMessage}</p>
        )}
